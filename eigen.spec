...
Source0  : https://bitbucket.org/eigen/eigen/get/3.3.5.tar.bz2
...
%prep
%setup -q -n eigen-eigen-b3f3d4950030
...
export LANG=C
export SOURCE_DATE_EPOCH=1532361557
mkdir clr-build
pushd clr-build
...
export SOURCE_DATE_EPOCH=1532361557
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/eigen
cp COPYING.README %{buildroot}/usr/share/doc/eigen/COPYING.README
cp COPYING.MPL2 %{buildroot}/usr/share/doc/eigen/COPYING.MPL2
cp COPYING.MINPACK %{buildroot}/usr/share/doc/eigen/COPYING.MINPACK
cp COPYING.LGPL %{buildroot}/usr/share/doc/eigen/COPYING.LGPL
cp COPYING.GPL %{buildroot}/usr/share/doc/eigen/COPYING.GPL
cp COPYING.BSD %{buildroot}/usr/share/doc/eigen/COPYING.BSD
cp bench/btl/COPYING %{buildroot}/usr/share/doc/eigen/bench_btl_COPYING
pushd clr-build
%make_install
popd
...
%files license
%defattr(-,root,root,-)
/usr/share/doc/eigen/COPYING.BSD
/usr/share/doc/eigen/COPYING.GPL
/usr/share/doc/eigen/COPYING.LGPL
/usr/share/doc/eigen/COPYING.MINPACK
/usr/share/doc/eigen/COPYING.MPL2
/usr/share/doc/eigen/COPYING.README
/usr/share/doc/eigen/bench_btl_COPYING
