...
%prep
%setup -q -n eigen-3.3.9
cd %{_builddir}/eigen-3.3.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607368113
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/eigen-3.3.9/COPYING.BSD %{buildroot}/usr/share/package-licenses/eigen/8fa159b3e41e0a44e10ea224cbb83e66ae02885e
cp %{_builddir}/eigen-3.3.9/COPYING.GPL %{buildroot}/usr/share/package-licenses/eigen/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/eigen-3.3.9/COPYING.LGPL %{buildroot}/usr/share/package-licenses/eigen/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/eigen-3.3.9/COPYING.MINPACK %{buildroot}/usr/share/package-licenses/eigen/df73e10dcfd2d05667e6fe85cabe5dfe3c984727
cp %{_builddir}/eigen-3.3.9/COPYING.MPL2 %{buildroot}/usr/share/package-licenses/eigen/9744cedce099f727b327cd9913a1fdc58a7f5599
cp %{_builddir}/eigen-3.3.9/COPYING.README %{buildroot}/usr/share/package-licenses/eigen/a7584db2e76a50884b3fe13360f2e6a354f5bedf
cp %{_builddir}/eigen-3.3.9/bench/btl/COPYING %{buildroot}/usr/share/package-licenses/eigen/0adba118df234d6b733bf662d159b55846231417
pushd clr-build
%make_install
popd
