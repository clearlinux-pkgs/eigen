...
Source0  : https://gitlab.com/libeigen/eigen/-/archive/3.4.0/eigen-3.4.0.tar.gz
Summary  : A C++ template library for linear algebra: vectors, matrices, and related algorithms
Group    : Development/Tools
License  : BSD-3-Clause GPL-2.0 GPL-3.0 LGPL-2.1 MPL-2.0 MPL-2.0-no-copyleft-exception
...
%prep
%setup -q -n eigen-3.4.0
cd %{_builddir}/eigen-3.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629327817
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/eigen-3.4.0/COPYING.BSD %{buildroot}/usr/share/package-licenses/eigen/68e70c33d6daa083bcc855b8984d2eadcb20e0b8
cp %{_builddir}/eigen-3.4.0/COPYING.GPL %{buildroot}/usr/share/package-licenses/eigen/8624bcdae55baeef00cd11d5dfcfa60f68710a02
cp %{_builddir}/eigen-3.4.0/COPYING.LGPL %{buildroot}/usr/share/package-licenses/eigen/01a6b4bf79aca9b556822601186afab86e8c4fbf
cp %{_builddir}/eigen-3.4.0/COPYING.MPL2 %{buildroot}/usr/share/package-licenses/eigen/9744cedce099f727b327cd9913a1fdc58a7f5599
cp %{_builddir}/eigen-3.4.0/COPYING.README %{buildroot}/usr/share/package-licenses/eigen/a7584db2e76a50884b3fe13360f2e6a354f5bedf
cp %{_builddir}/eigen-3.4.0/bench/btl/COPYING %{buildroot}/usr/share/package-licenses/eigen/0adba118df234d6b733bf662d159b55846231417
pushd clr-build
%make_install
popd
...
/usr/share/package-licenses/eigen/68e70c33d6daa083bcc855b8984d2eadcb20e0b8
